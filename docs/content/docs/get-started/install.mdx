...
<Steps>
  <Step>
    ### Download
    Download `Steam.Game.Idler_X.X.X_x64-setup.exe` from the [latest release](https://github.com/kaisma0/steam-game-idler/releases/latest/) page on GitHub
  </Step>
...
<Steps>
  <Step>
    ### Download
    Download `Steam.Game.Idler_X.X.X_x64-portable.zip` from the [latest release](https://github.com/kaisma0/steam-game-idler/releases/latest/) page on GitHub
  </Step>
