...
- Delete the games's achievement cache file and try again:
    1. Close SGI
    2. Navigate to `%appdata%/roaming/com.kaisma0.steam-game-idler/cache/{user_id}/achievement_data`
...
<Steps>
    ...
    2. Navigate to `%appdata%/roaming/com.kaisma0.steam-game-idler`
    ...
    ### Report Issues
    If you find persistent errors, include relevant log excerpts when [reporting issues on GitHub](https://github.com/kaisma0/steam-game-idler/issues/new?template=issue_report.yml)
</Steps>
...
2. **Search existing issues** on the [GitHub repository](https://github.com/kaisma0/steam-game-idler/issues)
