export const faqData = [
  ...
  },
  {
    ...
    markdown:
      ...
      '>\n' +
      '> If you confirm that you are logged in to the same account in both SGI and the Steam client and the error message persists, please report the issue on the [GitHub Issues page](https://github.com/kaisma0/steam-game-idler/issues).',
  },
  {
